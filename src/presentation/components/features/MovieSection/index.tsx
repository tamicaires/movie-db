...
export const MovieSection = memo(({ title, icon, gradient, movies, isLoading, viewAllLink, variant = 'default' }: MovieSectionProps) => {
  ...
  return (
    <section className="relative mb-12 -mx-4 px-4 py-6 overflow-hidden group/section">
      <div className={`absolute inset-0 bg-gradient-to-t ${gradient || 'from-surface/60 via-surface/30 to-transparent'} pointer-events-none`} />
